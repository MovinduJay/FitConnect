...
const PopularTeacher = () => {
  ...
  return (
    <div className='md:w-[80%] mx-auto my-36'>
        <div>
            <h1 className='text-5xl font-bold text-center'>Our <span className='text-secondary'>Amazing </span>
            Instructors</h1>
            ...
            <div className='grid mb-28 md:grid-cols-2 lg:grid-cols-4 w-[90%] gap-4 mx-auto'>
                {
                    instructors?.slice(0,4).map((instructor,i)=>(
                        <div className='flex- dark:text-white hover:-translate-y-2 duration-200 curso-pointer flex-col shadow-md py-8 md:px-8 rounded-md'>
